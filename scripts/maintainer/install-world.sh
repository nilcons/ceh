...
CEH_NO_BIN_CACHE= CEH_TWS64= CEH_TWSSUN= install tws-ui "TWS"
CEH_NO_BIN_CACHE= CEH_TWS64= CEH_TWSSUN=1 install tws-ui "TWS"
CEH_NO_BIN_CACHE= CEH_TWS64=1 CEH_TWSSUN= install tws-ui "TWS"
