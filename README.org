...
: ENSURE_BASE_NIXPATH=/nix/var/nix/profiles/ceh/essential/ ./ensure_base_installed.pl

+ Update CEH_BASELINE_PERL in =lib/perl=.

+ Update CEH_BASELINE_NIXPATH in =lib/CehBase.pm=.
