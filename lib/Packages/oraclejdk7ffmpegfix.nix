# Used by bin/javac
# TODO(errge): remove when https://github.com/NixOS/nixpkgs/pull/2101 is accepted

{
  packageOverrides = pkgs:
    {
      oraclejdk7 = pkgs.callPackage (
{ swingSupport ? true
, stdenv
, requireFile
, unzip
...
stdenv.mkDerivation rec {
   ...
   */
  libraries =
    [stdenv.gcc.libc glib libxml2 libav_0_8 libxslt mesa_noglu xlibs.libXxf86vm alsaLib fontconfig freetype gnome.pango gnome.gtk cairo gdk_pixbuf] ++
